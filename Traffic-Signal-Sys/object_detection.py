    ...
    for box in boxes:
        ...
        if label >= 0:
            ...
            if tf:
                ...
                cv2.waitKey(5)
                cv2.imwrite("C:/Users/MK/Desktop/Traffic-Signal-Sys/Detected Images/violation_"+str(dcnt)+".jpg", cimg)
                dcnt = dcnt+1
            else:
...
weights_path = "C:/Users/MK/Desktop/Traffic-Signal-Sys/weight_file.weights"
# set some parameters
net_h, net_w = 416, 416
